...
public class AntComponentReorder : EditorWindow
{
	...
	[MenuItem("Tools/Anthill/Component Reorder")]
	private static void ShowWindow()
	{
		AntComponentReorder window = (AntComponentReorder) GetWindow(typeof(AntComponentReorder), false, "Component Reorder");
	...
	private void OnGUI()
	{
		...
		{
			EditorGUILayout.LabelField("GameObject not selected in the Hierarchy", EditorStyles.miniBoldLabel);
		}
	}
