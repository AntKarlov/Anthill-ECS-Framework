...
namespace Anthill.Core
{
		...
		IExecuteFixedSystem, IExecuteLateSystem, ICleanupSystem, IEnableSystem, IDisableSystem, IResetSystem
	{
		...
		// -----------------------------------------------------
		// IInitializeSystem Implementation
		// -----------------------------------------------------
		...
		// -----------------------------------------------------
		// IDeinitializeSystem Implementation
		// -----------------------------------------------------
